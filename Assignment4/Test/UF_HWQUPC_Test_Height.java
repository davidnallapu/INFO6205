...
public class UF_HWQUPC_Test_Height {

    @Test
    public void testToString() {
        Connections h = new UF_HWQUPC_Height(2);
    ...
    public void testIsConnected02() {
        Connections h = new UF_HWQUPC_Height(1);
    ...
    public void testFind2() {
        UF h = new UF_HWQUPC_Height(3, false);
        h.connect(0, 1);
        assertEquals(0, h.find(0));
        assertEquals(0, h.find(1));
        h.connect(2, 1);
    ...
    public void testFind3() {
        UF h = new UF_HWQUPC_Height(6, false);
        h.connect(0, 1);
        h.connect(0, 2);
        h.connect(3, 4);
        h.connect(3, 5);
    ...
    public void testConnected01() {
        Connections h = new UF_HWQUPC_Height(10);
//        h.show();
        assertFalse(h.isConnected(0, 1));
    }
}